...
import type { RequestDraft } from '../../../../common/components/RequestResponseDialog/RequestResponseDialog.types'
import { useUpdateFileRequest } from '../../queries/useUpdateFileRequest'
import { useFileRequestFiles } from '../../queries/useFileRequestFiles'
import type { FileRequest, FileRequestStatus } from '../../types'
 ...
 */
export const useFileRequestDraft = (
  request: FileRequest,
  open: boolean,
): RequestDraft => {
  ...
  const setStatus = (status: FileRequestStatus) => setStatusDraft(status)
